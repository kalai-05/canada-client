          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="p-6 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Create and manage work orders with detailed checklists, customer
                info, and service notes.
              </p>
            </Card>
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Generate professional A4-size PDFs with company branding,
                signatures, and service details.
              </p>
            </Card>
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Securely store all work orders in Firebase with real-time sync
                across devices.
              </p>
            </Card>
          </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-red-600 to-blue-600">
        <div className="container mx-auto text-center">
          ...
          <p className="text-white text-lg mb-8 max-w-2xl mx-auto">
            Begin managing your HVAC service operations with Airsonic Work
            Manager today.
          </p>
          {user ? (
            <Link to="/create-work-order">
